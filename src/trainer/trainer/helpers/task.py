...
Original file: src/trainer/trainer/helpers/task.py
Author: naoto0804
...
COND_TYPES = [
    ...
    "partial_shift", #NEW* Shift opened elements to the beginning of seq
    "gt",  # just copy
...
def get_cond(
    ...
    refinement_noise_std: float = 0.1,
) -> Dict[str, Any]:
    ...
    if cond_type in ["partial", "partial_shift"]:
        ...
        new_bbox = bbox + torch.normal(0, std=refinement_noise_std, size=bbox.size())
