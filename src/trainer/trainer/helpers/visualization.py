...
Original file: src/trainer/trainer/helpers/visualization.py
Author: naoto0804
...
def convert_layout_to_image(
    ...
    **kwargs,
    ...
    if names:
        ...
        font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSansMono.ttf", W // 20)
    ...
    for i in indices:
        ...
        if resources:
            ...
            draw.rectangle([x1, y1, x2, y2], outline=colors[label], fill=c_fill, width=kwargs.get('line_width', 1))
            if names:
