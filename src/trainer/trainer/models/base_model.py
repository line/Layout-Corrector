...
Original file: src/trainer/trainer/models/base_model.py
Author: naoto0804
...
class BaseModel(torch.nn.Module):
    ...
    def compute_stats(self):
        num_params = self.calc_num_params()
        logger.info(
            "number of parameters: %e", (num_params / 1e6)
        )

    def calc_num_params(self) -> float:
